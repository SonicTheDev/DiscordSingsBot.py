    ...
    if client.user.id != message.author.id:
        if any(word in msg for word in singtrigger):
            if message.channel.id in client.sings_channel:
                ...
                responses = ["Trust me and we will escape from the city",
                             "THE POWER IS IN YOUR MIND TO SAVE THE PLANET TO CONQER TIME!",
                             "Sonic Boom Sonic Boom Sonic Boom",
                             "Trouble Keeps you running faster",
                             "Save the Planet from disaster",
                             "GREEN LIGHT RIIIIIDE!!!",]
...
async def help(ctx):
    ...
    embed.add_field(name="SOURCE CODE", value="Orignal: https://github.com/BoomerangRosalina/DiscordSingsBot.py\nRemade by: https://github.com/SonicTheDev", inline=False)
